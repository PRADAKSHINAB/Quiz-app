...
import { Link } from "react-navigate-dom"
    ...
    >
      ...
      <div className="container py-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4 animate-fadeIn">
          ...
          <Button onClick={() => navigate("/create")} className="rounded-xl h-12 px-6 bg-gradient-to-r from-violet-600 to-violet-500 hover:from-violet-700 hover:to-violet-600 text-white shadow-lg shadow-violet-500/25 transition-all hover:scale-105 active:scale-95 btn-ripple flex items-center gap-2">
          ...
          <TabsContent value="my-quizzes" className="space-y-6">
            ...
            {isLoading ? (
                  ...
                  <TiltCard key={quiz._id} className="glass-card rounded-2xl overflow-hidden group quiz-card-premium" intensity={6}>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between border-t border-border/50 pt-4 mt-auto">
                        <Button variant="ghost" size="sm" className="rounded-lg text-sm font-semibold hover:bg-violet-500/10 hover:text-violet-500 -ml-2" onClick={() => navigate(`/quiz/${quiz._id}`)}>
              ...
              <TiltCard className="glass-card rounded-3xl p-16 text-center max-w-2xl mx-auto border-dashed border-2" intensity={2}>
                ...
                <Button onClick={() => navigate("/create")} className="rounded-xl h-14 px-8 bg-gradient-to-r from-violet-600 to-violet-500 text-white shadow-xl hover:shadow-violet-500/40 transition-all hover:scale-105 active:scale-95 text-lg font-semibold">
