...
import { useNavigate, useSearchParams } from "react-navigate-dom"
import { Loader2, Eye, EyeOff, Brain, Sparkles } from "lucide-react"
          ...
          <div className="glass-card rounded-2xl overflow-hidden">
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full h-11 rounded-xl bg-gradient-to-r from-violet-600 to-violet-500 hover:from-violet-700 hover:to-violet-600 text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-all duration-300 font-medium"
                  disabled={isLoading}
                >
                  {isLoading ? (
