        ...
        <div className="glass-card rounded-3xl p-8 max-w-md w-full text-center relative z-10 animate-scale-in">
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button variant="outline" className="rounded-xl border-violet-200 dark:border-violet-800" onClick={() => navigate("/dashboard")}>
                Dashboard
              </Button>
              <Button variant="outline" className="rounded-xl border-violet-200 dark:border-violet-800" onClick={() => navigate("/topics")}>
                More Quizzes
              </Button>
            </div>
          </div>
      ...
      <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-14">
            <Button variant="ghost" size="sm" className="rounded-lg text-sm gap-1" onClick={() => navigate("/topics")}>
