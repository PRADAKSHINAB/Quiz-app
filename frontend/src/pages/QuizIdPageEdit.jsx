      ...
      <div className="container max-w-4xl py-8 space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-end space-x-4">
            <Button type="button" variant="outline" onClick={() => navigate("/dashboard")} disabled={isLoading} className="border-teal-200 text-teal-700 hover:bg-teal-50">Cancel</Button>
