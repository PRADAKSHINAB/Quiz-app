        ...
        <div className="glass-card rounded-3xl p-8 max-w-md w-full text-center relative z-10 animate-scale-in">
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {user ? (
                <Button variant="outline" className="rounded-xl border-violet-200 dark:border-violet-800" onClick={() => navigate("/dashboard")}>Dashboard</Button>
              ) : (
                <Button variant="outline" className="rounded-xl border-violet-200 dark:border-violet-800" onClick={() => navigate("/login")}>Sign In</Button>
              )}
              <Button variant="outline" className="rounded-xl border-violet-200 dark:border-violet-800" onClick={() => navigate("/topics")}>More Quizzes</Button>
            </div>
          </div>
        </div>
        {showShare && <SharePanel quiz={quiz} onClose={() => setShowShare(false)} />}
